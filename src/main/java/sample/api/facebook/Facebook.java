...
public class Facebook extends ApiBinding {
	...
	public List<Post> getFeed() {
		return restTemplate.getForObject(GRAPH_API_BASE_URL + "/me/feed?fields=created_time,caption,full_picture", Feed.class).getData();
	}

	public Groups getGroups() {
		return restTemplate.getForObject(GRAPH_API_BASE_URL + "/me/groups", Groups.class);
	}
